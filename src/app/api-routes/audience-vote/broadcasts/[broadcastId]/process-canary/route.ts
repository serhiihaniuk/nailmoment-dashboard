...
export async function POST(
  ...
  try {
    ...
    const broadcast = await processAudienceVoteBroadcastCanary({
    ...
    console.error("API Error processing audience vote broadcast canary:", error);
    const message =
      error instanceof Error
        ? error.message
        : "Could not process Audience Vote Broadcast canary.";
