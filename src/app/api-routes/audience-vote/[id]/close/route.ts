...
export async function POST(
  ...
  try {
    ...
    const vote = await audienceVoteService.closeAudienceVote(
    ...
    console.error("API Error closing audience vote:", error);
    return audienceVoteTransitionErrorResponse({
      error,
      fallbackMessage: "Could not close Audience Vote.",
    });
  }
}
